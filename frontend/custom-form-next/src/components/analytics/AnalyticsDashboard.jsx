    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="text-3xl font-bold text-gray-900 mt-2">{stats?.totalViews || 0}</div>
        </div>

        <div className="bg-white rounded-lg shadow p-6">
          <div className="text-sm font-medium text-gray-500">Total Responses</div>
          <div className="text-3xl font-bold text-gray-900 mt-2">{stats?.totalResponses || 0}</div>
        </div>
